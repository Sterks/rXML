...
// PurchaseProtocolRZ2ZPESMBO was generated 2020-11-10 17:46:27 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolRZ2ZPESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolRZ2ZPESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                           string `xml:",chardata"`
			Guid                           string `xml:"guid"`
			PurchaseProtocolRZ2ZPESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolRZ2ZPESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
