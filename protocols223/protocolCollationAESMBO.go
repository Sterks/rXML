...
// PurchaseProtocolCollationAESMBO was generated 2020-11-10 16:55:07 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolCollationAESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolCollationAESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                                string `xml:",chardata"`
			Guid                                string `xml:"guid"`
			PurchaseProtocolCollationAESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolCollationAESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
