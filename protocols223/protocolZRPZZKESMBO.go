...
// PurchaseProtocolZRPZZKESMBO was generated 2020-11-10 18:04:19 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolZRPZZKESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolZRPZZKESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                            string `xml:",chardata"`
			Guid                            string `xml:"guid"`
			PurchaseProtocolZRPZZKESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolZRPZZKESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
