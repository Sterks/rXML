...
// ProtocolCancellation was generated 2020-11-10 16:34:50 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type ProtocolCancellation struct {
	XMLName        xml.Name `xml:"protocolCancellation"`
	...
	Body struct {
		...
		Item struct {
			Text                     string `xml:",chardata"`
			Guid                     string `xml:"guid"`
			ProtocolCancellationData struct {
				Text                string `xml:",chardata"`
				Guid                string `xml:"guid"`
				CreateDateTime      string `xml:"createDateTime"`
				...
				CancellationReason string `xml:"cancellationReason"`
				Attachments        struct {
					Text                string `xml:",chardata"`
