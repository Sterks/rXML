...
// PurchaseProtocolRZ1ZPESMBO was generated 2020-11-10 17:40:38 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolRZ1ZPESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolRZ1ZPESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                           string `xml:",chardata"`
			Guid                           string `xml:"guid"`
			PurchaseProtocolRZ1ZPESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolRZ1ZPESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
