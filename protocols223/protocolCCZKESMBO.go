...
// PurchaseProtocolCCZKESMBO was generated 2020-11-10 16:51:25 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolCCZKESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolCCZKESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                          string `xml:",chardata"`
			Guid                          string `xml:"guid"`
			PurchaseProtocolCCZKESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolCCZKESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
