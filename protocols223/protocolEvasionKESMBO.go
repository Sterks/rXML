...
// PurchaseProtocolEvasionKESMBO was generated 2020-11-10 16:59:28 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolEvasionKESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolEvasionKESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                              string `xml:",chardata"`
			Guid                              string `xml:"guid"`
			PurchaseProtocolEvasionKESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolEvasionKESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
