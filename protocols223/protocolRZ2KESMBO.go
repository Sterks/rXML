...
// PurchaseProtocolRZ2KESMBO was generated 2020-11-10 17:45:12 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolRZ2KESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolRZ2KESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                          string `xml:",chardata"`
			Guid                          string `xml:"guid"`
			PurchaseProtocolRZ2KESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolRZ2KESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
