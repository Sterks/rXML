...
// PurchaseProtocolRZ1AE94FZ was generated 2020-11-10 17:35:06 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolRZ1AE94FZ struct {
	XMLName        xml.Name `xml:"purchaseProtocolRZ1AE94FZ"`
	...
	Body struct {
		...
		Item struct {
			Text                          string `xml:",chardata"`
			Guid                          string `xml:"guid"`
			PurchaseProtocolRZ1AE94FZData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolRZ1AE94FZData"`
		} `xml:"item"`
	} `xml:"body"`
}
