...
// PurchaseProtocolCCZPESMBO was generated 2020-11-10 16:53:09 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolCCZPESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolCCZPESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                          string `xml:",chardata"`
			Guid                          string `xml:"guid"`
			PurchaseProtocolCCZPESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolCCZPESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
