...
// PurchaseProtocolRZOK was generated 2020-11-10 17:51:09 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolRZOK struct {
	XMLName        xml.Name `xml:"purchaseProtocolRZOK"`
	...
	Body struct {
		...
		Item struct {
			Text                     string `xml:",chardata"`
			Guid                     string `xml:"guid"`
			PurchaseProtocolRZOKData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
				...
				ProtocolVKRegistrationNumber string `xml:"protocolVKRegistrationNumber"`
				ProtocolVKVersion            string `xml:"protocolVKVersion"`
