...
// PurchaseProtocolSummingupZKESMBO was generated 2020-11-10 17:57:00 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolSummingupZKESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolSummingupZKESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                                 string `xml:",chardata"`
			Guid                                 string `xml:"guid"`
			PurchaseProtocolSummingupZKESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolSummingupZKESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
