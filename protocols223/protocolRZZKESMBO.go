...
// PurchaseProtocolRZZKESMBO was generated 2020-11-10 17:52:32 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolRZZKESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolRZZKESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                          string `xml:",chardata"`
			Guid                          string `xml:"guid"`
			PurchaseProtocolRZZKESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolRZZKESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
