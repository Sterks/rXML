...
// PurchaseProtocolSummingupAESMBO was generated 2020-11-10 17:54:35 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolSummingupAESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolSummingupAESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                                string `xml:",chardata"`
			Guid                                string `xml:"guid"`
			PurchaseProtocolSummingupAESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolSummingupAESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
