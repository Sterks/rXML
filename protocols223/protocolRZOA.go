...
// PurchaseProtocolRZOA was generated 2020-11-10 17:50:00 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolRZOA struct {
	XMLName        xml.Name `xml:"purchaseProtocolRZOA"`
	...
	Body struct {
		...
		Item struct {
			Text                     string `xml:",chardata"`
			Guid                     string `xml:"guid"`
			PurchaseProtocolRZOAData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
