...
// PurchaseProtocolCCKESMBO was generated 2020-11-10 16:45:13 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolCCKESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolCCKESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                         string `xml:",chardata"`
			Guid                         string `xml:"guid"`
			PurchaseProtocolCCKESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolCCKESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
