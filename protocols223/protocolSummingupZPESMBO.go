...
// PurchaseProtocolSummingupZPESMBO was generated 2020-11-10 17:58:14 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolSummingupZPESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolSummingupZPESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                                 string `xml:",chardata"`
			Guid                                 string `xml:"guid"`
			PurchaseProtocolSummingupZPESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
				...
				LotApplicationsList     struct {
					...
					ProtocolLotApplications struct {
						...
						Application []struct {
							...
							AssessmentResult        string `xml:"assessmentResult"`
			...
			} `xml:"purchaseProtocolSummingupZPESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
