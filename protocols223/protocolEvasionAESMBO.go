...
// PurchaseProtocolEvasionAESMBO was generated 2020-11-10 16:58:10 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolEvasionAESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolEvasionAESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                              string `xml:",chardata"`
			Guid                              string `xml:"guid"`
			PurchaseProtocolEvasionAESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolEvasionAESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
