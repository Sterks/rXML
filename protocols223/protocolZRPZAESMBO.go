...
// PurchaseProtocolZRPZAESMBO was generated 2020-11-10 18:02:11 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolZRPZAESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolZRPZAESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                           string `xml:",chardata"`
			Guid                           string `xml:"guid"`
			PurchaseProtocolZRPZAESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolZRPZAESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
