...
// PurchaseProtocolEvasionZKESMBO was generated 2020-11-10 17:00:43 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolEvasionZKESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolEvasionZKESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                               string `xml:",chardata"`
			Guid                               string `xml:"guid"`
			PurchaseProtocolEvasionZKESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolEvasionZKESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
