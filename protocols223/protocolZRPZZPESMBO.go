...
// PurchaseProtocolZRPZZPESMBO was generated 2020-11-10 18:05:19 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolZRPZZPESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolZRPZZPESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                            string `xml:",chardata"`
			Guid                            string `xml:"guid"`
			PurchaseProtocolZRPZZPESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolZRPZZPESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
