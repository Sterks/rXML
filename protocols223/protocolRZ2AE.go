...
// PurchaseProtocolRZ2AE94FZ was generated 2020-11-10 17:41:46 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolRZ2AE94FZ struct {
	XMLName        xml.Name `xml:"purchaseProtocolRZ2AE94FZ"`
	...
	Body struct {
		...
		Item struct {
			Text                          string `xml:",chardata"`
			Guid                          string `xml:"guid"`
			PurchaseProtocolRZ2AE94FZData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolRZ2AE94FZData"`
		} `xml:"item"`
	} `xml:"body"`
}
