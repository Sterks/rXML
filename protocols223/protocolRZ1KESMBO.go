...
// PurchaseProtocolRZ1KESMBO was generated 2020-11-10 17:39:32 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolRZ1KESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolRZ1KESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                          string `xml:",chardata"`
			Guid                          string `xml:"guid"`
			PurchaseProtocolRZ1KESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
				...
				LotApplicationsList     struct {
					...
					ProtocolLotApplications struct {
						...
						Criteria struct {
							Text                    string `xml:",chardata"`
							LotApplicationsCriteria []struct {
								Text     string `xml:",chardata"`
								Guid     string `xml:"guid"`
								Name     string `xml:"name"`
								MaxValue string `xml:"maxValue"`
								Weight   string `xml:"weight"`
							} `xml:"lotApplicationsCriteria"`
						} `xml:"criteria"`
						Application struct {
							Text              string `xml:",chardata"`
			...
			} `xml:"purchaseProtocolRZ1KESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
