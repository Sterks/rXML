...
// PurchaseProtocolSummingupKESMBO was generated 2020-11-10 17:55:46 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolSummingupKESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolSummingupKESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                                string `xml:",chardata"`
			Guid                                string `xml:"guid"`
			PurchaseProtocolSummingupKESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolSummingupKESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
