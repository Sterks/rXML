...
// PurchaseProtocolRZ1AESMBO was generated 2020-11-10 17:38:08 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolRZ1AESMBO struct {
	XMLName        xml.Name `xml:"purchaseProtocolRZ1AESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                          string `xml:",chardata"`
			Guid                          string `xml:"guid"`
			PurchaseProtocolRZ1AESMBOData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
			...
			} `xml:"purchaseProtocolRZ1AESMBOData"`
		} `xml:"item"`
	} `xml:"body"`
}
