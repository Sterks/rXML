...
// PurchaseProtocolPAEP was generated 2020-11-10 17:28:25 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseProtocolPAEP struct {
	XMLName        xml.Name `xml:"purchaseProtocolPAEP"`
	...
	Body struct {
		...
		Item struct {
			Text                     string `xml:",chardata"`
			Guid                     string `xml:"guid"`
			PurchaseProtocolPAEPData struct {
				Text           string `xml:",chardata"`
				Guid           string `xml:"guid"`
				CreateDateTime string `xml:"createDateTime"`
