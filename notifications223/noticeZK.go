...
// PurchaseNoticeZK was generated 2020-11-09 23:45:51 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseNoticeZK struct {
	XMLName        xml.Name `xml:"purchaseNoticeZK"`
		...
		Item struct {
			...
			PurchaseNoticeZKData struct {
				...
				Contact struct {
					...
					Phone                 string `xml:"phone"`
					Email                 string `xml:"email"`
					AdditionalContactInfo string `xml:"additionalContactInfo"`
				} `xml:"contact"`
				...
				QuotationExaminationTime  string `xml:"quotationExaminationTime"`
				QuotationExaminationPlace string `xml:"quotationExaminationPlace"`
				QuotationExaminationOrder string `xml:"quotationExaminationOrder"`
				QuotationForm             string `xml:"quotationForm"`
				SubmissionCloseDateTime   string `xml:"submissionCloseDateTime"`
				SummingupDate             string `xml:"summingupDate"`
			} `xml:"purchaseNoticeZKData"`
		} `xml:"item"`
	} `xml:"body"`
}
