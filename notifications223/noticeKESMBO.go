...
// PurchaseNoticeKESMBO was generated 2020-11-09 23:35:16 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseNoticeKESMBO struct {
	XMLName        xml.Name `xml:"purchaseNoticeKESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                     string `xml:",chardata"`
			Guid                     string `xml:"guid"`
			PurchaseNoticeKESMBOData struct {
				Text               string `xml:",chardata"`
				Guid               string `xml:"guid"`
				CreateDateTime     string `xml:"createDateTime"`
