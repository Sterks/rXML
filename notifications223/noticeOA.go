...
// PurchaseNoticeOA was generated 2020-11-09 23:44:29 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseNoticeOA struct {
	XMLName        xml.Name `xml:"purchaseNoticeOA"`
	...
	Body struct {
		...
		Item struct {
			Text                 string `xml:",chardata"`
			Guid                 string `xml:"guid"`
			PurchaseNoticeOAData struct {
				Text               string `xml:",chardata"`
				Guid               string `xml:"guid"`
				CreateDateTime     string `xml:"createDateTime"`
				UrlOOS             string `xml:"urlOOS"`
				...
				AuctionPlace            string `xml:"auctionPlace"`
