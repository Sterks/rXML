...
// PurchaseNoticeZKESMBO was generated 2020-11-09 23:50:48 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseNoticeZKESMBO struct {
	XMLName        xml.Name `xml:"purchaseNoticeZKESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                      string `xml:",chardata"`
			Guid                      string `xml:"guid"`
			PurchaseNoticeZKESMBOData struct {
				Text               string `xml:",chardata"`
				Guid               string `xml:"guid"`
				CreateDateTime     string `xml:"createDateTime"`
				...
				DocumentationDelivery string `xml:"documentationDelivery"`
				...
				PlacingProcedure        string `xml:"placingProcedure"`
