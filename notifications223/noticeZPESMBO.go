...
// PurchaseNoticeZPESMBO was generated 2020-11-09 23:52:01 by DESKTOP-ES8AI3K\runov on DESKTOP-ES8AI3K.
type PurchaseNoticeZPESMBO struct {
	XMLName        xml.Name `xml:"purchaseNoticeZPESMBO"`
	...
	Body struct {
		...
		Item struct {
			Text                      string `xml:",chardata"`
			Guid                      string `xml:"guid"`
			PurchaseNoticeZPESMBOData struct {
				Text               string `xml:",chardata"`
				Guid               string `xml:"guid"`
				CreateDateTime     string `xml:"createDateTime"`
						...
						LotData        struct {
							...
							LotItems struct {
								...
								LotItem  struct {
									...
									CommodityItemPrice string `xml:"commodityItemPrice"`
								} `xml:"lotItem"`
							} `xml:"lotItems"`
							ForSmallOrMiddle          string `xml:"forSmallOrMiddle"`
